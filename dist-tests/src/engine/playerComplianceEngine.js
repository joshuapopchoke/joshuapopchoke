...
exports.createInsiderInfoEvent = createInsiderInfoEvent;
exports.evaluateInsiderDecision = evaluateInsiderDecision;
...
function evaluateInsiderDecision(event, decision, currentViolationCount) {
